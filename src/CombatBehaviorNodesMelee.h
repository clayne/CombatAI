...
class CombatBehaviorTreeCreateContextNode2_CombatBehaviorContextMelee_CombatBehaviorExpression_CombatBehaviorMemberFunc_CombatBehaviorEquipContext_NiPointer_CombatInventoryItem__const_____ptr64____cdecl_CombatBehaviorEquipContext_____void_const___ptr64____CombatBehaviorContextMelee__ATTACK_TYPE_ : public CombatBehaviorTreeCreateContextNodeBase_CombatBehaviorContextMelee_
{
public:
...
private:
	...
	using createnewImpl_t = CombatBehaviorTreeCreateContextNode2_CombatBehaviorContextMelee_CombatBehaviorExpression_CombatBehaviorMemberFunc_CombatBehaviorEquipContext_NiPointer_CombatInventoryItem__const_____ptr64____cdecl_CombatBehaviorEquipContext_____void_const___ptr64____CombatBehaviorContextMelee__ATTACK_TYPE_* (*)();
	inline static const createnewImpl_t createnewImpl = xbyakCode.getCode<createnewImpl_t>();
};
static_assert(sizeof(CombatBehaviorTreeCreateContextNode2_CombatBehaviorContextMelee_CombatBehaviorExpression_CombatBehaviorMemberFunc_CombatBehaviorEquipContext_NiPointer_CombatInventoryItem__const_____ptr64____cdecl_CombatBehaviorEquipContext_____void_const___ptr64____CombatBehaviorContextMelee__ATTACK_TYPE_) == 0x38);
using NodeMeleeContext = CombatBehaviorTreeCreateContextNode2_CombatBehaviorContextMelee_CombatBehaviorExpression_CombatBehaviorMemberFunc_CombatBehaviorEquipContext_NiPointer_CombatInventoryItem__const_____ptr64____cdecl_CombatBehaviorEquipContext_____void_const___ptr64____CombatBehaviorContextMelee__ATTACK_TYPE_;
