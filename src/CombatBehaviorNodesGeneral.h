...
using NodeNextChildSelector = CombatBehaviorTreeNodeObject_CombatBehaviorFallbackSelector_NextChildSelector___;

DECLARE_CombatBehaviorTreeNodeObject(CombatBehaviorChildSelector_ConditionalChildSelector__);  // 141695EF0 141695F50
using NodeConditionalChildSelector = CombatBehaviorTreeNodeObject_CombatBehaviorChildSelector_ConditionalChildSelector___;
...
class CombatBehaviorTreeValueNode_unsigned_int_ : public CombatBehaviorTreeWrapperNode  // 1416941F0
{
public:
	inline static constexpr auto RTTI = RE::RTTI_CombatBehaviorTreeValueNode_unsigned_int_;

	void* destroy(char need_freeself) override;
	RE::BSFixedString* __unk_9() override;
	virtual uint32_t __unk10(void);
};
static_assert(sizeof(CombatBehaviorTreeValueNode_unsigned_int_) == 0x30);
...
class CombatBehaviorTreeNodeValueNodeT_unsigned_int_int_ : public CombatBehaviorTreeValueNode_unsigned_int_
{
public:
	inline static constexpr auto RTTI = RE::RTTI_CombatBehaviorTreeValueNodeT_unsigned_int_int_;
...
static_assert(sizeof(CombatBehaviorTreeNodeValueNodeT_unsigned_int_int_) == 0x38);

// valuenode_14 1407DA3C0
class CombatBehaviorTreeNodeValueNodeT_unsigned_int_CombatBehaviorExpression_CombatBehaviorMemberFunc_CombatBehaviorContextCloseMovement_bool____cdecl_CombatBehaviorContextCloseMovement_____void_const___ptr64______ : public CombatBehaviorTreeValueNode_unsigned_int_
{
public:
	inline static constexpr auto RTTI = RE::RTTI_CombatBehaviorTreeValueNodeT_unsigned_int_CombatBehaviorExpression_CombatBehaviorMemberFunc_CombatBehaviorContextCloseMovement_bool____cdecl_CombatBehaviorContextCloseMovement_____void_const___ptr64_____;
...
static_assert(sizeof(CombatBehaviorTreeNodeValueNodeT_unsigned_int_CombatBehaviorExpression_CombatBehaviorMemberFunc_CombatBehaviorContextCloseMovement_bool____cdecl_CombatBehaviorContextCloseMovement_____void_const___ptr64______) == 0x38);

class CombatBehaviorTreeValueNodeT_float_CombatBehaviorExpression_CombatBehaviorFunc1_float____cdecl___Actor_____ptr64__CombatBehaviorTree__CombatBehaviorAttacker_____ : public CombatBehaviorTreeValueNode_float_  // 141696778
{
public:
	inline static constexpr auto RTTI = RE::RTTI_CombatBehaviorTreeValueNodeT_float_CombatBehaviorExpression_CombatBehaviorFunc1_float____cdecl___Actor_____ptr64__CombatBehaviorTree__CombatBehaviorAttacker_____;
...
static_assert(sizeof(CombatBehaviorTreeValueNodeT_float_CombatBehaviorExpression_CombatBehaviorFunc1_float____cdecl___Actor_____ptr64__CombatBehaviorTree__CombatBehaviorAttacker_____) == 0x40);

// valuenode_10 8176B0
class CombatBehaviorTreeValueNodeT_unsigned_int_CombatBehaviorExpression_CombatBehaviorMemberFunc_Actor_bool____cdecl_Actor_____void_const___ptr64_____ : public CombatBehaviorTreeValueNode_unsigned_int_  // 14169CDC8
{
public:
	inline static constexpr auto RTTI = RE::RTTI_CombatBehaviorTreeValueNodeT_unsigned_int_CombatBehaviorExpression_CombatBehaviorMemberFunc_Actor_bool____cdecl_Actor_____void_const___ptr64_____;
...
static_assert(sizeof(CombatBehaviorTreeValueNodeT_unsigned_int_CombatBehaviorExpression_CombatBehaviorMemberFunc_Actor_bool____cdecl_Actor_____void_const___ptr64_____) == 0x40);
