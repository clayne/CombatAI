...
DEFINE_CombatBehaviorTreeNodeObject_createnew(CombatBehaviorFallbackSelector_NextChildSelector_, 32407);
DEFINE_CombatBehaviorTreeNodeObject_createnew(CombatBehaviorChildSelector_ConditionalChildSelector_, 46756);
